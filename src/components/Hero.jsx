  ...
  return (
    <section className="relative w-full h-screen md:h-[100vh] overflow-hidden bg-gradient-to-b from-cream-primary via-cream-blush to-cream-primary flex items-center">
      ...
      <div className="absolute inset-0 flex items-center justify-center px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 max-w-7xl w-full items-center">
          {/* Left: Vertical Text */}
          <motion.div
            className="hidden md:flex absolute left-0 top-1/2 -translate-y-1/2 opacity-60"
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.6 }}
          ...
          {/* Center: Hero Content */}
          <motion.div
            className="col-span-1 md:col-span-6 md:col-start-4 text-center md:text-left"
