    ...
    <section className="section-spacing section-padding">
      <div className="max-w-4xl mx-auto text-center">
        <div className="animate-slide-up">
          <p className="text-2xl md:text-3xl font-serif text-cocoa-dark leading-relaxed mb-8">
          ...
          <div className="w-24 h-px bg-gradient-to-r from-transparent via-caramel-gold to-transparent mx-auto" />
          
          <p className="text-lg text-text-muted mt-8 font-light tracking-wide">
