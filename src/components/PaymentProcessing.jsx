...
const PaymentProcessing = ({ 
  ...
  if (status === 'processing') {
    return (
      <div className="fixed inset-0 bg-chocolate-dark/95 z-50 flex items-center justify-center">
        <div className="card-luxury p-12 max-w-md w-full mx-4 text-center">
          {/* Processing Animation */}
          <div className="relative mb-8">
            <div className="w-24 h-24 mx-auto bg-caramel-gold/20 rounded-full flex items-center justify-center">
              <Loader2 size={32} className="text-caramel-gold animate-spin" />
            </div>
            ...
            <svg className="absolute inset-0 w-24 h-24 mx-auto transform -rotate-90">
              ...
              <circle
                ...
                className="text-caramel-gold transition-all duration-500"
                strokeLinecap="round"
              />
            </svg>
          </div>
          ...
          <div className="w-full bg-cream-beige rounded-full h-2 mb-4">
            <div 
      ...
      <div className="fixed inset-0 bg-chocolate-dark/95 z-50 flex items-center justify-center">
        <div className="card-luxury p-12 max-w-md w-full mx-4 text-center">
          ...
          <div className="flex items-center justify-center">
            <Loader2 size={20} className="text-caramel-gold animate-spin" />
          </div>
        </div>
      </div>
    )
